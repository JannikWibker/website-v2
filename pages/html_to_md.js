...
const info = {
  'html_to_md': [
    ...
    <p>Ever wanted to turn existing HTML into markdown? No? Yeah maybe it's not super useful but it has its use cases:
      <ul>
  ...
  'features': [
    <p><em>html_to_md</em> has support for many html elements (unsupported elements are just ignored):
      <ul>
        <li>spans</li>
        <li>links (<em>a</em>)</li>
